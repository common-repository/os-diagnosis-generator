...
$user_page_view=<<<_EOD_
					<span class="label">
						<label for="diagnosis-name" class="label-diagnosis-name">{$class->h($data['form_input_label'])}</label>
					</span>
_EOD_
;
$user_contents .= $user_page_view."\n";
...
$user_page_view=<<<_EOD_
					<span class="cols">
						<input type="text" name="diagnosis_name" id="diagnosis-name" placeholder="{$placeholder}" value="{$class->post_set('diagnosis_name', '1')}" />
					</span>
_EOD_
;
$user_contents .= $user_page_view."\n";
...
$user_page_view=<<<_EOD_
					<div id="block-question{$q}" class="question">
						<div class="qcontents"><span class="question-number">問{$q}</span><span class="question-delimiter"> : </span><span class="question-text">{$question['text']}</span></div>
...
$user_page_view=<<<_EOD_
					...
					<div class="submit">
						...
						<input type="submit" name="submit" class="sbm-button" value="{$sbm_text}" />
					</div>
_EOD_
;
$user_contents .= $user_page_view."\n";
